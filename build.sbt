...
lazy val thehiveDemisto = (project in file("thehive-demisto"))
  .dependsOn(thehiveBackend)
  .settings(publish := {})
...
lazy val main = (project in file("."))
  ...
  .dependsOn(thehiveBackend, thehiveMetrics, thehiveMisp, thehiveDemisto, thehiveCortex)
  .aggregate(thehiveBackend, thehiveMetrics, thehiveMisp, thehiveDemisto, thehiveCortex)
